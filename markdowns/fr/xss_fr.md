...
// ici exo dvwa server //
@[Launch the server]({ "stubs": ["code.js"], "project":"exo3", "command": "git clone https://github.com/seraum/hackmyfortress-vuln-testing.git app && cd app && nodejs wf.js && sudo echo 'TECHIO> open -p 8080 /index.php'" })
