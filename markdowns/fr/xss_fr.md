...
// ici exo dvwa server //
@[Launch the server]({ "stubs": ["code.js"], "project":"exo3", "command": "sh -c \"sudo ulimit -n 8192 && ulimit -u 10240\" && service apache2 start && sudo echo 'TECHIO> open -p 80 /index.php'" })
